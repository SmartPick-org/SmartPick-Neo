...
# 데이터셋이 거의 변하지 않는다는 가정하에 런타임 1회 로드 캐시
_ALL_CARDS_CACHE: Optional[list[dict]] = None
...
def calculate_benefits_node(state: AgentState):
    ...
    for card in filtered_cards:
        ...
        try:
            ...
            min_perf = card["card_meta"].get("minimum_performance", 0)
    ...
    _test_log["calc_results"] = [
        {
            ...
            "annual_breakdown": r["annual_breakdown"],
            "warnings": r["warnings"],
        }
