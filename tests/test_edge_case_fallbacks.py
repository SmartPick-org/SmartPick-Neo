...
#     # DI 우회: FastAPI가 의존성 해결 시 실패하지 않도록 override
#     fastapi_app.dependency_overrides[dependencies.get_recommend_service] = lambda: StubCardRecommendService(None)
#     fastapi_app.dependency_overrides[dependencies.get_explain_service] = lambda: StubExplainService()
#     fastapi_app.dependency_overrides[dependencies.get_digest_repository] = lambda: type("FakeDigest", (), {"get_digest": AsyncMock(return_value="digest")})()

#     # 핸들러가 DI를 무시하고 직접 생성하므로 모듈 레벨에서도 패치
